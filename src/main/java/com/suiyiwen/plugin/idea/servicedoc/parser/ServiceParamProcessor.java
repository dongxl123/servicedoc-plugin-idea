...
import com.suiyiwen.plugin.idea.servicedoc.bean.servicedoc.ServiceParam;
 ...
 */
public class ServiceParamProcessor extends AbstractTagProcessor {


    @Override
    public ServiceDocElement parse(List<String> textList) {
        ServiceParam element = new ServiceParam();
    ...
    public String buildValue(ServiceDocElement element) {
        if (element instanceof ServiceParam) {
            ServiceParam tElement = (ServiceParam) element;
