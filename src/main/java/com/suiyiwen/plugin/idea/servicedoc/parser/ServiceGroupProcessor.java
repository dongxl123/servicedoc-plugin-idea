...
import com.suiyiwen.plugin.idea.servicedoc.bean.servicedoc.ServiceGroup;
 ...
 */
public class ServiceGroupProcessor extends AbstractTagProcessor {

    @Override
    public ServiceDocElement parse(List<String> textList) {
        ServiceGroup element = new ServiceGroup();
    ...
    public String buildValue(ServiceDocElement element) {
        if (element instanceof ServiceGroup) {
            ServiceGroup tElement = (ServiceGroup) element;
